            ...
            <Box borderColor="grey.200" borderWidth={1} borderRadius={20} padding={6}>
              <Flex direction="row" justify="space-between">
                <Flex direction="row" justify="space-around" align="center">
                  <img
                    src={getPicture(watchTokenIn.value)}
                    defaultsource={getPicture(watchTokenIn.value)}
                    alt={watchTokenIn.value}
                  />
              ...
              <Flex direction="row" justify="space-between">
                <Flex direction="row" justify="space-around" align="center">
                  <img
                    src={getPicture(watchTokenOut.value)}
                    defaultsource={getPicture(watchTokenOut.value)}
                    alt={watchTokenOut.value}
                  />
                  <Text fontSize="1.6em" fontFamily="Poppins" fontWeight="500">
                    {price}
                  </Text>
