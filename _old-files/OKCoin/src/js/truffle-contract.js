            ...
            Contract._static_methods = {
              ...
              at: function (address) {
                ...
                if (address == null || typeof address != 'string' || address.length != 42) {
                  throw new Error(
                    'Invalid address passed to ' + this._json.contract_name + '.at(): ' + address
                  );
                }
      ...
      function (require, module, exports) {
        ...
        contract.fromSolJS = function (soljs_abstraction, ignore_default_network) {
          ...
          Object.keys(soljs_abstraction.all_networks).forEach(function (network_name) {
            ...
            if (
              soljs_abstraction.all_networks[network_name].updated_at > latest_network_updated_at
            ) {
      ...
      function (require, module, exports) {
        (function (Buffer) {
          ...
          function encodeMethod(method, values) {
            var signature =
              method.name + '(' + utils.getKeys(method.inputs, 'type').join(',') + ')';
            var signatureEncoded =
              '0x' + new Buffer(utils.keccak256(signature), 'hex').slice(0, 4).toString('hex');
        ...
        (function (Buffer) {
          ...
          function getKeys(params, key, allowEmpty) {
            ...
            if (!Array.isArray(params)) {
              throw new Error(
                '[ethjs-abi] while getting keys, invalid params value ' + JSON.stringify(params)
              );
            }
            ...
            return {
              ...
              decode: function decodeFixedBytes(data, offset) {
                if (data.length < offset + 32) {
                  throw new Error(
                    '[ethjs-abi] while decoding fixed bytes, invalid bytes data length: ' + length
                  );
                }
